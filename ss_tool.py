...
[data-testid="stFileUploader"] {
    background: linear-gradient(90deg, #3a0068 0%, #6a1b9a 55%, #9c27b0 100%) !important; border:2px dashed rgba(255,255,255,0.4) !important; border-radius:14px !important;
}
